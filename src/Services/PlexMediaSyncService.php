...
class PlexMediaSyncService implements MediaSyncInterface
{
	...
	public function setPlexSettings()
	{
		...
		$this->plexSettings['plexMovieLibraries'] = Plugin::getOptionValue('plex_movie_libraries');
		$this->plexSettings['plexTvLibraries'] = Plugin::getOptionValue('plex_tv_libraries');
	}
	...
	public function updateSettings($request)
	{
		...
		Plugin::updateOption('plex_movie_libraries', $request->plex_password);
		Plugin::updateOption('plex_tv_libraries', $request->plex_password);
	}
